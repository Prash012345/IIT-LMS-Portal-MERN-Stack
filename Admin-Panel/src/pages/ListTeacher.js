...
function ListTeacher() {
    ...
    async function getTeacher() {
        var resp = await fetch('https://iit-mern-backend.onrender.com/teacher/list');
        var rdata = await resp.json();
        // setteacher(data);
        setTeacher(rdata.data);
                    ...
                    <div id="layoutSidenav_content">
                        <main>
                            <div className="container-fluid px-4">
                                <h1 className="mt-4">Teacher's List</h1>
                            </div>
                            {teacher.map(p => (
                                        ...
                                        <div className="row">
                                            <div className="col-md-4">
                                                <div className="profile-img">
                                                    ...
                                                    <img src={`https://iit-mern-backend.onrender.com/teacher/` + p.profile_img} alt="avatar" className="rounded-circle img-fluid" style={{ width: 150 }} />
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="profile-head">
                                                    ...
                                                    <p className="proile-rating">#<span>{i++}</span></p>
                                            ...
                                            <button type="button" className="btn btn-danger" onClick={async () => {
                                                                var fd = new FormData();
                                                                fd.append("id", p._id);
                                                                var resp = await fetch("https://iit-mern-backend.onrender.com/teacher/del", {
                                                                    method: 'POST',
                                                                    body: fd
                                                                });
