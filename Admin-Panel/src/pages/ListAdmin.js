...
function ListAdmin() {
    ...
    async function getAdmin() {
        var resp = await fetch('https://iit-mern-backend.onrender.com/admin/list');
                    ...
                    <div id="layoutSidenav_content">
                        <main>
                            <div className="container-fluid px-4">
                                <h1 className="mt-4">Admin's List</h1>
                            </div>
                            {admin.map(p => (
                                    ...
                                    <form method="post">
                                        <div className="row">
                                            ...
                                            <button type="button" className="btn btn-danger" onClick={async () => {
                                                                var fd = new FormData();
                                                                fd.append("id", p._id);
                                                                var resp = await fetch("https://iit-mern-backend.onrender.com/admin/del", {
                                                                    method: 'POST',
                                                                    body: fd
                                                                });
